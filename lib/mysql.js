 ...
 */
exports.queryFn = function(sql, params, isquery, callback) {
	var ckey = "";
	isquery = isquery==undefined ? false : isquery;
 ...
 * @param {Object} params 数组类型，依次传入sql语句中？定义的参数
 */
exports.query = function(sql, params, isquery) {
	return q.ninvoke(exports, 'queryFn', sql, params, isquery)
}

exports.transaction = function(sql_list, params_list) {
	return q.ninvoke(exports, 'transactionFn', sql_list, params_list)
}
