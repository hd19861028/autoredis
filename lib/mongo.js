...
exports.findOneAndUpdate = function(table, filter, data, options) {
	...
	getConnection().then(function(db) {
		...
		d.resolve(collection.findOneAndUpdate(filter, set, options))
	}, function(err) {
		d.reject(err);
	})
	return d.promise;
...
exports.findAndRemove = function(table, filter, sort, options) {
	...
	getConnection().then(function(db) {
		...
		d.resolve(collection.findAndRemove(filter, sort, options))
	}, function(err) {
		d.reject(err);
	})
	return d.promise;
...
exports.findOneAndDelete = function(table, filter, options) {
	...
	getConnection().then(function(db) {
		...
		d.resolve(collection.findOneAndDelete(filter, options))
	}, function(err) {
		d.reject(err);
	})
	return d.promise;
...
exports.ensureIndex = function(table, filter, options) {
	...
	getConnection().then(function(db) {
		var collection = db.collection(table);
		d.resolve(collection.ensureIndex(filter, options));
	}, function(err) {
		d.resolve(null);
	})
	return d.promise;
